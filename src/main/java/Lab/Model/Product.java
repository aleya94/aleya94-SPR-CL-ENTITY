...
@Entity // @TODO - Add an annotation to indicate that this class is mapped to a relation in the database:

public class Product {
    @Id // TODO - Add an annotation to indicate that this field is the primary key for the corresponding relation:
